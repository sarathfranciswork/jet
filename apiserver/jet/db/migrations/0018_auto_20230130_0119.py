...
import jet.db.models.api_token
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(default=jet.db.models.api_token.generate_token, max_length=255, unique=True)),
                ('label', models.CharField(default=jet.db.models.api_token.generate_label_token, max_length=255)),
