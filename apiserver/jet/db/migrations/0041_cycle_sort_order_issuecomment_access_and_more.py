...
import jet.db.models.exporter
import jet.db.models.project
import uuid
import random
import string
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(default=jet.db.models.exporter.generate_token, max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Last Modified At')),
                ('id', models.UUIDField(db_index=True, default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('anchor', models.CharField(db_index=True, default=jet.db.models.project.get_anchor, max_length=255, unique=True)),
                ('comments', models.BooleanField(default=False)),
                ('reactions', models.BooleanField(default=False)),
                ('votes', models.BooleanField(default=False)),
                ('views', models.JSONField(default=jet.db.models.project.get_default_views)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created_by', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
