...
from jet.api.serializers import IssueActivitySerializer
from jet.bgtasks.notification_task import notifications
        ...
        if requested_data.get("archived_at") is None:
            ...
            issue_activities.append(
                IssueActivity(
                    ...
                    project_id=project_id,
                    workspace_id=workspace_id,
                    comment="Jet has archived the issue",
                    verb="updated",
                    actor_id=actor_id,
                    field="archived_at",
                    old_value=None,
    ...
    if requested_data.get("closed_to") is not None:
        ...
        issue_activities.append(
            IssueActivity(
                ...
                project_id=project_id,
                workspace_id=workspace_id,
                comment=f"Jet updated the state to ",
                old_identifier=None,
