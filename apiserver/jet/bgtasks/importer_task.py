...
# Module imports
from jet.api.serializers import ImporterSerializer
...
from jet.bgtasks.user_welcome_task import send_welcome_slack
        ...
        if len(users):
            ...
            _ = [
                send_welcome_slack.delay(
                    str(user.id),
                    True,
                    f"{user.email} was imported to Jet from {service}",
                )
