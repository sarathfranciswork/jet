...
# Module imports
from jet.db.models import Project, User, ProjectMemberInvite
...
def project_invitation(email, project_id, token, current_site):
    try:
        ...
        subject = f"{project.created_by.first_name or project.created_by.email} invited you to join {project.name} on Jet"
